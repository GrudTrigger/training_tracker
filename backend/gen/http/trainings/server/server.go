...
// New instantiates HTTP handlers for all the trainings service endpoints using
...
func (s *Server) Service() string { return "trainings" }
...
func (s *Server) MethodNames() []string { return trainings.MethodNames[:] }
...
// MountCreateHandler configures the mux to serve the "trainings" service
// "create" endpoint.
